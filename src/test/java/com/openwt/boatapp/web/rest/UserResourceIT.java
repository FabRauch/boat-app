...
import com.openwt.boatapp.domain.Authority;
...
import com.openwt.boatapp.service.mapper.UserMapper;
import com.openwt.boatapp.web.rest.vm.ManagedUserVM;
...
class UserResourceIT {
    ...
    private static final String UPDATED_LOGIN = "from";

    private static final Long DEFAULT_ID = 1L;

    private static final String DEFAULT_PASSWORD = "passjohndoe";
    private static final String UPDATED_PASSWORD = "passfrom";

    private static final String DEFAULT_EMAIL = "johndoe@localhost";
    private static final String UPDATED_EMAIL = "from@localhost";

    private static final String DEFAULT_FIRSTNAME = "john";
    private static final String UPDATED_FIRSTNAME = "boatFirstName";

    private static final String DEFAULT_LASTNAME = "doe";
    private static final String UPDATED_LASTNAME = "boatLastName";
