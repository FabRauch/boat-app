...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './boat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOAT actions', async () => {
      const expectedActions = [
        {
